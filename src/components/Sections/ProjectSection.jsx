  ...
  return (
    ...
    >
      ...
      <div className="abosolute inset-0 overflow-hidden">
        <div
          className={`absolute top-20 left-1/4 w-96 h-80 rounded-full blur-3xl opacity-5 ${isDarkMode ? "bg-blue-500" : "bg-blue-400"
            }`}
        />
        <div
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.h2
            variants={itemVariants}
            className="text-3xl md:text-5xl fot-light mb-6"
          >
            Recent
          ...
          >
            A collection of projects showcase my expertise in building modern
        ...
        <motion.div
          ...
          animate={isInView ? "visible" : "hidden"}
          variants={containerVariants}
          className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 my-24"
        >
