...
function Footer() {
    ...
    const AnimatedGradientLine = () => {
        <div className="absolute top-0 left-0 w-full h-px overflow-hidden">
            <motion.div
                className={`h-px bg-gradient-to-r ${isDarkMode ? "from-transparant via-blue-500 to-transparent"
                    : "from-transparant via-blue-600 to-transparent"
                    }`}
            ...
            />
            <motion.div
                className={`absolute top-0 h-px w-32 bg-gradient-to-r ${isDarkMode ? "from-blue-400 via-purple-500 to-blue-400"
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="space-y-4">
                            ...
                            >
                                Crafting digital experience with passion, precision and touch of magic
                        ...
                        >
                            ...
                            {/* <div className={`h-px w-16 ${isDarkMode ? "bg-gray-700" : "bg-ray-300"}`} /> */}
                        </motion.div>
                        ...
                        <motion.div variants={itemVariants} className="space-y-2">
                            <p className={`text-sm ${isDarkMode ? "text-gray-500" : "text-gray-600"}`}>
                                © {new Date().getFullYear()}  Prajakta Yelgave. All rights reserved.
                            </p>
                            <p className={`text-xs ${isDarkMode ? "text-gray-600" : "text-gray-500"}`}>
                                Built with React and Framer Motion - Design with care
                            </p>
                        </motion.div>
                        ...
                        <motion.div variants={itemVariants}>
                            <motion.button
                                onClick={scrollToTop}
                                className={`inline-flex items-center space-x-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${isDarkMode ? "bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 hover:text-white"
