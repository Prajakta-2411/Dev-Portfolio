  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
        <div
          className={`absolute top-20 left-1/4 w-72 h-2 rounded-full blur-3xl opacity-5 ${isDarkMode ? "bg-blue-500" : "bg-blue-400"
            }`}
        />
        <div
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              <h3 className="text-2xl font-medium mb-8">Send me message</h3>
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <h3 className="text-2xl font-medium mb-6">Contact Informtion</h3>
            ...
            >
              ...
              >
                I am currently available for full time opportunity
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          ...
          >
            ...
            <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
              Sometimes a conversion is worth a thousand messages. Feel free to
              schedule a call to discuss your project.
            </p>
            <motion.button
              whileHover={{ y: -2, scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className={`px-6 py-3 mt-4 rounded-full border font-medium transition-all duration-300 ${isDarkMode
