...
export default function SkillsSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="skills"
      className={`py-20 px-6 ${isDarkMode ? "bg-gray-950 text-white" : "bg-gray-50 text-gray-900"
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Skills &
            <span className="text-blue-500 font-meium">Technologies</span>
          </motion.h2>
          <motion.p
            variants={itemVariants}
          ...
          >
            A comphrehensive toolkit for building modern, scalable web
        ...
        >
          {SKILLS_CATEGORY.map((category) => (
            <motion.div
              key={category.title}
              variants={itemVariants}
              className={`p-8 roundedd-2xl border ${isDarkMode
