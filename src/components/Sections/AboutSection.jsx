      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              <h3 className="text-xl font-medium mb-6">My Mission</h3>
              <p
                className={`text-lg leading-relaxed mb-6 ${isDarkMode ? "text-gray-300" : "text-gray-700"
                  }`}
              >
                {/* I am a passionate web developer dedicated to crafting engaging
                and user-friendly digital experiences. With a strong foundation
                in front-end technologies, I specialize in creating responsive
                and visually appealing websites that not only look great but
                also perform seamlessly across all devices. My mission is to
                leverage my skills and creativity to build innovative web
                applications that solve real-world problems and enhance user
                interactions. I am committed to continuous learning and growth,
                always striving to stay at the forefront of the ever-evolving
                web development landscape.  */}
                I believe technology should be bridge that connects people and
              ...
              >
                ...
                frameworks,contributing to open source, or mentoring aspiring
                developers. I love the constant evolution of technologies and
                the endless possibilities they bring to create meaningful
                digital experiences.
              </p> */}
            </motion.div>
                ...
                {PASSIONS.map((passion, index) => (
                  <motion.div
                    ...
                    className={`flex items-center space-x-4 p-4 rounded-xl ${isDarkMode
                      ? "bg-gray-800/30 hover:bg-ray-800/50"
                      : "bg-gray50/50 hover:bg-gray-100/50"
            ...
            <motion.div variants={itemVariants} className="text-center py-8">
              ...
              <div className="flex justify-center">
                <img src={SIGNATURE} alt="sign" className="w-28" />
              </div>
