...
function TextInput({ isDarkMode, value, handleInputChange, textarea, label }) {
  ...
  return (
    <div className="relative">
      <InputComponent
        type="text"
        className={`w-full px-4 pt-6 pb-1 border rounded-xl transition-all duration-300 outline-none resize-none ${
          isDarkMode
